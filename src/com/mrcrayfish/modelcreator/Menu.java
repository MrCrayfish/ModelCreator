...
public class Menu extends JMenuBar {
    ...
    private void initMenu() {
        ...
        JMenu menuScreenshot = new JMenu("Screenshot");
    ...
    private void initActions() {
        ...
        itemMF.addActionListener(a -> JOptionPane.showMessageDialog(null, "This option has not been added yet. Please wait until the next preview."));
        itemPM.addActionListener(a -> JOptionPane.showMessageDialog(null, "This option has not been added yet. Please wait until the next preview."));
        itemGitHub.addActionListener(a -> Util.openUrl("https://github.com/MrCrayfish/ModelCreator"));
        itemDonate.addActionListener(a -> Util.openUrl("https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=HVXLDWFN4MNA2"));
        itemModelCauldron.addActionListener(a -> Util.loadModelFromJar(creator.getElementManager(), getClass(), "models/cauldron"));
        itemModelChair.addActionListener(a -> Util.loadModelFromJar(creator.getElementManager(), getClass(), "models/modern_chair"));
    }
